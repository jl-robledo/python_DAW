...
import euromillon_funciones_dc_jlr
...
euromillon_funciones_dc_jlr.datosAlumnos()

# Mostramos la lista de los numeros y estrellas que podemos elegir    
euromillon_funciones_dc_jlr.mostrarBoleto(listaNumeros, listaEstrellas)

# Creamos el boleto con los numeros y estrellas que se introduzcan por el usuario
euromillon_funciones_dc_jlr.crearBoletoNumero(listaNumeros, combinacionElegidaNumeros)
euromillon_funciones_dc_jlr.crearBoletoEstrellas(listaEstrellas, combinacionElegidaEstrellas)

# Mostramos la combinacion elegida por el usuario
euromillon_funciones_dc_jlr.mostrarBoleto(listaNumeros, listaEstrellas)

# Se hace el sorteo con los numeros y estrellas
euromillon_funciones_dc_jlr.generarSorteo(combinacionGanadoraNumeros, combinacionGanadoraEstrellas)

# Comprobamos los numeros y estrellas que se han acertado
euromillon_funciones_dc_jlr.comprobarPremio(combinacionElegidaNumeros, combinacionElegidaEstrellas, combinacionGanadoraNumeros, combinacionGanadoraEstrellas)
