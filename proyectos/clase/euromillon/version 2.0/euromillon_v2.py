...
import euromillon_funciones_v2
...
euromillon_funciones_v2.datosAlumnos()

# Mostramos la lista de los numeros y estrellas que podemos elegir    
euromillon_funciones_v2.mostrarBoleto(listaNumeros, listaEstrellas)

# Creamos el boleto con los numeros y estrellas que se introduzcan por el usuario
euromillon_funciones_v2.crearBoletoNumero(listaNumeros, combinacionElegidaNumeros)
euromillon_funciones_v2.crearBoletoEstrellas(listaEstrellas, combinacionElegidaEstrellas)

# Mostramos la combinacion elegida por el usuario
euromillon_funciones_v2.mostrarBoleto(listaNumeros, listaEstrellas)

# Se hace el sorteo con los numeros y estrellas
euromillon_funciones_v2.generarSorteo(combinacionGanadoraNumeros, combinacionGanadoraEstrellas)

# Comprobamos los numeros y estrellas que se han acertado
euromillon_funciones_v2.comprobarPremio(combinacionElegidaNumeros, combinacionElegidaEstrellas, combinacionGanadoraNumeros, combinacionGanadoraEstrellas)
